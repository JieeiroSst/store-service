...
func NewAccessGenerate() *AccessTokenGenerate {
	return &AccessTokenGenerate{}
}

// AccessGenerate generate the access token
type AccessTokenGenerate struct {
}

// Token based on the UUID generated token
func (ag *AccessTokenGenerate) Token(ctx context.Context, data *GenerateBasic, isGenRefresh bool) (string, string, error) {
