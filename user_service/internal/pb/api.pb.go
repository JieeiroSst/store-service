...
func (x *AuthenticationReponse) Reset() {
	*x = AuthenticationReponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *AuthenticationReponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AuthenticationReponse) ProtoMessage() {}

func (x *AuthenticationReponse) ProtoReflect() protoreflect.Message {
	mi := &file_internal_proto_api_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AuthenticationReponse.ProtoReflect.Descriptor instead.
func (*AuthenticationReponse) Descriptor() ([]byte, []int) {
	return file_internal_proto_api_proto_rawDescGZIP(), []int{1}
}

func (x *AuthenticationReponse) GetCode() string {
	if x != nil {
		return x.Code
	}
	return ""
...
func (x *AuthenticationReponse) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
var file_internal_proto_api_proto_rawDesc = []byte{
	...
	0x65, 0x63, 0x74, 0x5f, 0x67, 0x72, 0x70, 0x63, 0x22, 0x49, 0x0a, 0x15, 0x41, 0x75, 0x74, 0x68,
	...
	,
...
var file_internal_proto_api_proto_goTypes = []interface{}{
	(*AuthenticationRequest)(nil), // 0: project_grpc.AuthenticationRequest
	(*AuthenticationReponse)(nil), // 1: project_grpc.AuthenticationReponse
}
var file_internal_proto_api_proto_depIdxs = []int32{
	0, // 0: project_grpc.Authentication.Authentication:input_type -> project_grpc.AuthenticationRequest
	1, // 1: project_grpc.Authentication.Authentication:output_type -> project_grpc.AuthenticationReponse
...
func file_internal_proto_api_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_internal_proto_api_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AuthenticationReponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
