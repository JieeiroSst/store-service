...
import (
	...
	bankingGrpc "github.com/JIeeiroSst/lib-gateway/account-transaction-service/gateway/account-transaction-service"
	"github.com/JIeeiroSst/utils/logger"
	"github.com/Jieeirosst/account-transaction-service/config"
	grpchandler "github.com/Jieeirosst/account-transaction-service/internal/adapter/primary/grpc"
...
func New(p Params) {
	...
	bankingGrpc.RegisterBankingServiceServer(grpcServer, p.Handler)
	...
	p.LC.Append(fx.Hook{
		OnStart: func(ctx context.Context) error {
			...
			if err := bankingGrpc.RegisterBankingServiceHandlerFromEndpoint(
