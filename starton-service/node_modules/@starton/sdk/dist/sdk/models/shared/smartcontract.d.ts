...
export declare class Abi extends SpeakeasyBase {
}
export declare class CompilationDetails extends SpeakeasyBase {
}
...
export declare enum SmartContractStatus {
    Unsigned = "UNSIGNED",
    ErrorTx = "ERROR_TX",
...
export declare class SmartContract extends SpeakeasyBase {
    abi?: Abi[];
    address: string;
    blockNumber?: number;
