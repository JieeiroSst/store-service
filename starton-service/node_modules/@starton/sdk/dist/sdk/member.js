...
var Member = /** @class */ (function () {
    function Member(sdkConfig) {
        this.sdkConfiguration = sdkConfig;
        this.invitation = new invitation_1.Invitation(this.sdkConfiguration);
    }
    /**
     ...
     */
    Member.prototype.delete = function (req, config) {
        var _a, _b;
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        operationUrl = utils.generateURL(baseURL, "/v3/project-member/{userId}", req);
                    ...
                    case 3:
                        ...
                        res = new operations.DeleteProjectMemberResponse({
     ...
     */
    Member.prototype.getAll = function (config) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            var baseURL, operationUrl, client, globalSecurity, properties, headers, httpRes, responseContentType, res, decodedRes;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        baseURL = utils.templateUrl(this.sdkConfiguration.serverURL, this.sdkConfiguration.serverDefaults);
                        operationUrl = baseURL.replace(/\/$/, "") + "/v3/project-member";
                        client = this.sdkConfiguration.defaultClient;
                        globalSecurity = this.sdkConfiguration.security;
                        if (!(typeof globalSecurity === "function")) return [3 /*break*/, 2];
                        return [4 /*yield*/, globalSecurity()];
                    ...
                    case 3:
                        ...
                        res = new operations.GetAllProjectMemberResponse({
                            statusCode: httpRes.status,
                            contentType: responseContentType,
                            rawResponse: httpRes,
                        });
                        ...
                        switch (true) {
                            case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                                if (utils.matchContentType(responseContentType, "application/json")) {
                                    res.projectMemberPaginated = utils.objectToClass(JSON.parse(decodedRes), operations.GetAllProjectMemberProjectMemberPaginated);
                                }
                                else {
                                    throw new errors.SDKError("unknown content-type received: " + responseContentType, httpRes.status, decodedRes, httpRes);
                                }
