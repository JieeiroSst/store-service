...
var Setting = /** @class */ (function () {
     ...
     */
    Setting.prototype.get = function (req, config) {
        var _a, _b;
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        operationUrl = utils.generateURL(baseURL, "/v3/setting/relayer/{network}", req);
                    ...
                    case 3:
                        ...
                        res = new operations.GetAllSettingRelayerResponse({
                        ...
                        switch (true) {
                            case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                                if (utils.matchContentType(responseContentType, "application/json")) {
                                    res.settingRelayer = utils.objectToClass(JSON.parse(decodedRes), shared.SettingRelayer);
                                }
                                else {
     ...
     */
    Setting.prototype.update = function (req, config) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        try {
                            _d = __read(utils.serializeRequestBody(req, "updateSettingRelayerDto", "json"), 2), reqBodyHeaders = _d[0], reqBody = _d[1];
                        }
                        catch (e) {
                    ...
                    case 3:
                        ...
                        res = new operations.UpdateSettingRelayerResponse({
                            statusCode: httpRes.status,
                            contentType: responseContentType,
                            rawResponse: httpRes,
                        });
