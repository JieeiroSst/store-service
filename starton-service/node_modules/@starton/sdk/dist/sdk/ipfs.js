...
var Ipfs = /** @class */ (function () {
     ...
     */
    Ipfs.prototype.delete = function (req, config) {
        var _a, _b;
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        operationUrl = utils.generateURL(baseURL, "/v3/ipfs/pin/{id}", req);
                    ...
                    case 3:
                        ...
                        res = new operations.DeletePinResponse({
     ...
     */
    Ipfs.prototype.getAll = function (req, config) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        baseURL = utils.templateUrl(this.sdkConfiguration.serverURL, this.sdkConfiguration.serverDefaults);
                        operationUrl = baseURL.replace(/\/$/, "") + "/v3/ipfs/pin";
                        client = this.sdkConfiguration.defaultClient;
                        globalSecurity = this.sdkConfiguration.security;
                        if (!(typeof globalSecurity === "function")) return [3 /*break*/, 2];
                        return [4 /*yield*/, globalSecurity()];
                    ...
                    case 3:
                        ...
                        res = new operations.GetAllPinResponse({
                            statusCode: httpRes.status,
                            contentType: responseContentType,
                            rawResponse: httpRes,
                        });
                        ...
                        switch (true) {
                            case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                                if (utils.matchContentType(responseContentType, "application/json")) {
                                    res.pinPaginated = utils.objectToClass(JSON.parse(decodedRes), operations.GetAllPinPinPaginated);
                                }
                                else {
                                    throw new errors.SDKError("unknown content-type received: " + responseContentType, httpRes.status, decodedRes, httpRes);
                                }
     ...
     */
    Ipfs.prototype.getOne = function (req, config) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            var baseURL, operationUrl, client, globalSecurity, properties, headers, queryParams, httpRes, responseContentType, res, decodedRes;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        ...
                        res = new operations.GetOnePinResponse({
                            statusCode: httpRes.status,
                            contentType: responseContentType,
                            rawResponse: httpRes,
                        });
     ...
     */
    Ipfs.prototype.getStorageUsed = function (config) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            var baseURL, operationUrl, client, globalSecurity, properties, headers, httpRes, responseContentType, res, decodedRes;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        baseURL = utils.templateUrl(this.sdkConfiguration.serverURL, this.sdkConfiguration.serverDefaults);
                        operationUrl = baseURL.replace(/\/$/, "") + "/v3/ipfs/storage-used";
                        client = this.sdkConfiguration.defaultClient;
                        globalSecurity = this.sdkConfiguration.security;
                        if (!(typeof globalSecurity === "function")) return [3 /*break*/, 2];
                        return [4 /*yield*/, globalSecurity()];
                    ...
                    case 3:
                        ...
                        res = new operations.GetStorageUsedPinResponse({
                            statusCode: httpRes.status,
                            contentType: responseContentType,
                            rawResponse: httpRes,
                        });
                        ...
                        switch (true) {
                            case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                                if (utils.matchContentType(responseContentType, "application/json")) {
                                    res.storageUsed = utils.objectToClass(JSON.parse(decodedRes), shared.StorageUsed);
                                }
                                else {
                                    throw new errors.SDKError("unknown content-type received: " + responseContentType, httpRes.status, decodedRes, httpRes);
                                }
     ...
     */
    Ipfs.prototype.pinExistingFile = function (req, config) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 3:
                        ...
                        res = new operations.CreatePinResponse({
                            statusCode: httpRes.status,
                            contentType: responseContentType,
                            rawResponse: httpRes,
                        });
     ...
     */
    Ipfs.prototype.update = function (req, config) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            var baseURL, operationUrl, _c, reqBodyHeaders, reqBody, client, globalSecurity, properties, headers, httpRes, responseContentType, res, decodedRes;
            var _d;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        _c = __read([{}, null], 2), reqBodyHeaders = _c[0], reqBody = _c[1];
                        try {
                            _d = __read(utils.serializeRequestBody(req, "updatePinDto", "json"), 2), reqBodyHeaders = _d[0], reqBody = _d[1];
                        }
                        catch (e) {
                            if (e instanceof Error) {
                                throw new Error("Error serializing request body, cause: ".concat(e.message));
                    ...
                    case 3:
                        ...
                        res = new operations.UpdatePinResponse({
                            statusCode: httpRes.status,
                            contentType: responseContentType,
                            rawResponse: httpRes,
                        });
     ...
     */
    Ipfs.prototype.uploadFile = function (req, config) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            var baseURL, operationUrl, _c, reqBodyHeaders, reqBody, client, globalSecurity, properties, headers, httpRes, responseContentType, res, decodedRes;
            var _d;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        baseURL = utils.templateUrl(this.sdkConfiguration.serverURL, this.sdkConfiguration.serverDefaults);
                        operationUrl = baseURL.replace(/\/$/, "") + "/v3/ipfs/file";
                        _c = __read([{}, null], 2), reqBodyHeaders = _c[0], reqBody = _c[1];
                        try {
                    ...
                    case 3:
                        ...
                        res = new operations.UploadFromFilePinResponse({
                            statusCode: httpRes.status,
                            contentType: responseContentType,
                            rawResponse: httpRes,
                        });
     ...
     */
    Ipfs.prototype.uploadFolder = function (req, config) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            var baseURL, operationUrl, _c, reqBodyHeaders, reqBody, client, globalSecurity, properties, headers, httpRes, responseContentType, res, decodedRes;
            var _d;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        baseURL = utils.templateUrl(this.sdkConfiguration.serverURL, this.sdkConfiguration.serverDefaults);
                        operationUrl = baseURL.replace(/\/$/, "") + "/v3/ipfs/folder";
                        _c = __read([{}, null], 2), reqBodyHeaders = _c[0], reqBody = _c[1];
                        try {
                            _d = __read(utils.serializeRequestBody(req, "request", "multipart"), 2), reqBodyHeaders = _d[0], reqBody = _d[1];
                        }
                    ...
                    case 3:
                        ...
                        res = new operations.UploadFromFolderPinResponse({
                            statusCode: httpRes.status,
                            contentType: responseContentType,
                            rawResponse: httpRes,
                        });
     ...
     */
    Ipfs.prototype.uploadJson = function (req, config) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            var baseURL, operationUrl, _c, reqBodyHeaders, reqBody, client, globalSecurity, properties, headers, httpRes, responseContentType, res, decodedRes;
            var _d;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        baseURL = utils.templateUrl(this.sdkConfiguration.serverURL, this.sdkConfiguration.serverDefaults);
                        operationUrl = baseURL.replace(/\/$/, "") + "/v3/ipfs/json";
                        _c = __read([{}, null], 2), reqBodyHeaders = _c[0], reqBody = _c[1];
                        try {
                            _d = __read(utils.serializeRequestBody(req, "request", "json"), 2), reqBodyHeaders = _d[0], reqBody = _d[1];
                        }
                    ...
                    case 3:
                        ...
                        res = new operations.UploadFromJsonPinResponse({
                            statusCode: httpRes.status,
                            contentType: responseContentType,
                            rawResponse: httpRes,
                        });
